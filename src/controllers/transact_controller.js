...
const UpdateTransactionExecutionDate = async (req, res) => {
  ...
  module.exports = { GetCurrentTransactionLog, GetFutureTransactionLog, UpdateTransactionExecutionDate, InvestInTopSchemes, InvestInExistingSchemes, AllSchemeList };